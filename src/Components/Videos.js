...
export default function Videos() {
  ...
  // axios.get(VIDEO_URL)
  // .then((response)=> setVideoData(response.json()))
  // .then((responseData)=> setVideoData(responseData.data))
  // .catch((error)=> {return error})

  let videoResult = videoData.items[0].player.embedHtml;

  return (
    <div className="text-center pt-5 d-flex flex-column">
      {/* <div dangerouslySetInnerHTML={{ __html: videoResult }} /> */}
